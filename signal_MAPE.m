function MAPE = signal_MAPE( sig, t, sig_ref, t_ref )
%SIGNAL_MAPE - Calculate mean absolute percentage error of sig to reference sig_ref
%   Output is a scalar.
%
%   Syntax:
...
%
%   Outputs:
%       MAE - Mean asolute percentage error signal
%
%
...
%
%   See also: signal_MAE, signal_RMSE
%
%   Author: Marius Oei
